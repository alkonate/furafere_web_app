    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
                <div class="modal-header">
                        <h5 class="modal-title">{{__('Product Info')}}</h5>
                                ...
                                <div class="card-body bg-secondary text-light">
                                    <div class="row">
                                        <div class="col-6"  id="fieldNames">
                                            <p class="card-text" id="fieldName">{{__('Product')}}</p>
                                            <p class="card-text" id="fieldStockCount">{{__('Stock count')}}</p>
                                            <p class="card-text" id="fieldAvailableCount">{{__('Available stock count')}}</p>
                                            <p class="card-text" id="fieldOutOfStockCount">{{__('Out of stock count')}}</p>
